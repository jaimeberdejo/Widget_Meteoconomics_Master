...
FILES_BIENES = {
    'EU': DATA_DIR / 'bienes_agregado.csv',      # Eurostat (DE, ES, FR, IT)
    'US': DATA_DIR / 'us_bienes_agregado.csv',
    'GB': DATA_DIR / 'uk_bienes_agregado.csv',
    'JP': DATA_DIR / 'jp_bienes_agregado.csv',
    'CA': DATA_DIR / 'ca_bienes_agregado.csv',
}

FILES_SOCIOS = {
    'EU': DATA_DIR / 'comercio_socios.csv',
    'US': DATA_DIR / 'us_comercio_socios.csv',
    'GB': DATA_DIR / 'uk_comercio_socios.csv',
    'JP': DATA_DIR / 'jp_comercio_socios.csv',
    'CA': DATA_DIR / 'ca_comercio_socios.csv',
}
...
def integrate_bienes():
    ...
    std_cols = ['fecha', 'pais', 'pais_code', 'sector', 'sector_code',
...
def integrate_socios():
    ...
    # Columnas estándar
    std_cols = ['fecha', 'pais', 'pais_code', 'socio', 'socio_code',
